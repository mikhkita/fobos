	...
	<div class="b b-8">
		...
		<div class="b-back" id="invest-final">
			...
			<div class="solution-back">
				<div>
					<h5>Отчетность</h5>
					<p>В любой точке мира вы можете моментально узнатьо состоянии своего счета и о всех осуществленных транзакциях, обратившись к ежедневному отчетуилинапрямую к своему персональному менеджеру.</p>
				</div>
				<div>
					<h5>Результат</h5>
