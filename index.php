				...
				<li data-block="#fiz">
					<div>	
						<div class="mobile-service">	
							...
							<p class="desc-mobile">Вы&nbsp;&mdash; успешный деловой человек, имеющий возможность позволить себе размещать временно свободные денежные средства с&nbsp;целью получения дополнительного дохода.</p>
						</div>
						<? if( $mobile ): ?>
